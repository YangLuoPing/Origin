...
public class dbConfig {
	...
	static {
		...
		InputStream config = dbConfig.class.getClassLoader().getResourceAsStream("coder/codegenerte_config.properties");
		InputStream database = dbConfig.class.getClassLoader()
				.getResourceAsStream("coder/codegenerte_database.properties");
